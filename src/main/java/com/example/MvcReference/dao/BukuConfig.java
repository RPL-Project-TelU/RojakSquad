...
public class BukuConfig {
    ...
    CommandLineRunner commandLineRunner(BukuRepository bukuRepository) {
        return args -> {
            ...
            Buku buku2 = new Buku("Pemrograman Algoritma II", "Dadang", "Sinar Mars");
            Buku buku3 = new Buku("Arsitektur Komputer", "Udin", "Sinar Mars");
            Buku buku4 = new Buku("Pemrograman Dasar", "Udin", "Sinar Mars");
